 ...
 */
package pl.beone.ai.platformsample;
...
public class DemoComponent extends AbstractModuleComponent {
    ...
    /**
     * Injects the {@link NodeService} dependency used to perform operations
     * on repository nodes, such as counting child associations.
     *
     * @param nodeService the Alfresco {@code NodeService} instance to be injected
     */
    ...
    /**
     * Injects the {@link NodeLocatorService}, which allows convenient lookup
     * of common repository nodes such as "Company Home".
     *
     * @param nodeLocatorService the Alfresco {@code NodeLocatorService} instance to be injected
     */
